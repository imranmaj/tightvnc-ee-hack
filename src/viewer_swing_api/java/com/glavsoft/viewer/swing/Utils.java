 ...
 */
public class Utils {
	private static List<Image> icons = new LinkedList<Image>();

	public static List<Image> getApplicationIcons() {
        if ( ! icons.isEmpty()) return icons;
        for (String icoSize : new String[]{"16x16", "32x32", "48x48", "128x128"}) {
            URL resource = Utils.class.getResource("/com/glavsoft/viewer/images/tightvnc-logo-" + icoSize + ".png");
